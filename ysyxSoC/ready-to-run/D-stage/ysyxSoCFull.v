...
module MemBridge(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      logic [1:0] _stateD_T_22 = io_master_arready ? 2'h2 : 2'h1;
      logic [1:0] _stateD_T_24 = {~io_master_rvalid, 1'h0};
      logic [2:0] _stateD_T_30 = {1'h1, io_master_wready, 1'h0};
      logic [2:0] _stateD_T_21 =
        _io_master_wvalid_T
          ? (isValidLoad
               ? {1'h0, _stateD_T_22}
               : isValidStore
...
module sdramChisel(
  ...
  always @(posedge io_clk) begin
    logic       _GEN = io_cke & cmd == 4'h5;
    logic [3:0] _GEN_0;
    logic       _GEN_1 = io_cke & cmd == 4'h4;
